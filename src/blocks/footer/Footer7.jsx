...
// Defensive fallback for branding structure
const company = branding.company || {};
const socialLink = company.socialLink || {};
...
const data = [
  ...
  },
  {
    ...
    menu: [
      ...
      {
        label: 'Support',
        link: { href: socialLink.support || '#', ...linkProps }
      },
      {
        label: 'License Terms',
      ...
      {
        label: 'Discord',
        link: { href: socialLink.discord || '#', ...linkProps }
      }
    ]
  },
  {
